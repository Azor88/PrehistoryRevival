package com.azor.prehistoryrevival.entity.custom;
...
public class AnkyloEntity extends Animal {
    public AnkyloEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.ANKYLO.get().create(pLevel);
    }
